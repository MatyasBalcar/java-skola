...
public class SAXReceiptReaderWriterTest {
    @Test
    ...
    private static Receipt getReceipt() throws Exception {
        ...
        SAXReceiptReaderWriter readerWriter = new SAXReceiptReaderWriter();
        return readerWriter.loadReceipt(input);
    }

    @Test
    public void testStoreReceiptThrowsException() {
        SAXReceiptReaderWriter readerWriter = new SAXReceiptReaderWriter();
        assertThrows(UnsupportedOperationException.class, () -> readerWriter.storeReceipt(null, null));
    }
}
